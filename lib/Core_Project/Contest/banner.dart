...
class ScreenBanner extends StatefulWidget {
  final Size size;
  const ScreenBanner({required this.size, super.key});

  @override
  State<ScreenBanner> createState() => _ScreenBanner();
}

class _ScreenBanner extends State<ScreenBanner> with TickerProviderStateMixin {
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (_, child) => Transform.translate(
                      ...
                      child: Transform.rotate(
                        angle: 0.05 * math.sin(_controller.value * 4 * math.pi),
                        child: child,
                      ),
                    ),
